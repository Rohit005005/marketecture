...
export default function CloudKitchenAndOfficeSpaceSetup() {
        ...
        >
            <div className="items-start justify-start">
                <div className="w-[633px] flex flex-col items-start justify-start gap-6 max-w-full">
                    <h1 className="text-[40px] py-08 font-[700] italic">Cloud Kitchen and Office Space Setup</h1>
                    <div
                    ...
                    >
                        In the evolving business landscape, flexibility is key.
                        We provide comprehensive setup services for cloud kitchens and office spaces,
                        equipping you with everything needed to run your operations smoothly and efficiently.
                    </div>
                </div>
            </div>
