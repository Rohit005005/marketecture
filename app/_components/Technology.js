...
export default function Technology() {
    return (
        <div className={` w-[1440px] max-w-full overflow-hidden flex flex-col items-end justify-start py-20 px-[13px] box-border relative gap-[57px] leading-[normal] tracking-[normal] text-left text-[40px] text-black font-body-1-bold ${PropTypes.string}`}>
