...
export default function Services() {
    return (
        <div className={`bg-[url('../public/bg.png')] h-full bg-no-repeat bg-cover bg-center w-[1440px] max-w-full overflow-hidden flex flex-col items-start justify-start py-20 px-[103px] box-border relative gap-[57px] leading-[normal] tracking-[normal] text-left text-[40px] text-black font-body-1-bold ${PropTypes.string}`}>
