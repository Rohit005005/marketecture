        ...
        >
            <div className="items-start justify-start">
                <div className="w-[633px] flex flex-col items-start justify-start gap-6 max-w-full">
                    <h1 className="text-[40px] py-08 font-[700] italic">Real Estate</h1>
                    <div
                    ...
                    >
                        Are you searching for a new home? We’ve got you covered on all fronts,
                        whether you\'re looking for a new flat or villa from a trusted A-category builder,
                        or even planning to construct a house from scratch.
                    </div>
                </div>
            </div>
