        ...
        >
            <div className="items-start justify-start">
                <div className="w-[633px] flex flex-col items-start justify-start gap-6 max-w-full">
                    <h1 className="text-[40px] py-08 font-[700] italic">Materials Procurement</h1>
                    <div
                    ...
                    >
                        We source all necessary materials for your projects, ensuring high quality and timely delivery.
                        Our extensive network of suppliers allows us to provide competitive prices and reliable service.
                    </div>
                </div>
            </div>
